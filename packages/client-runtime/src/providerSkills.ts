import type { ServerProviderSkill, ServerProviderSlashCommand } from "@cadsense/contracts";

export type ProviderSkillSourceKind = "app" | "project" | "personal" | "system" | "other";

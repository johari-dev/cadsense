import type { OrchestrationShellSnapshot } from "@cadsense/contracts";
 ...
 * Decouples the shell state machine from the underlying HTTP authorization and
...
>()("@cadsense/client-runtime/state/shellSnapshotHttp/ShellSnapshotLoader") {}

...
>(threads: readonly T[], projectId: ProjectId, sortOrder: ThreadSortOrder): T | null {
  return (
    sortThreads(
...
// writes ONE key to ONE thread, leaving neighboring records untouched while
// every connected client converges on the same order.

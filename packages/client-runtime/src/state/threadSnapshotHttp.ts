import type { OrchestrationThreadDetailSnapshot, ThreadId } from "@cadsense/contracts";
...
export type FetchEnvironmentThreadSnapshotError = EnvironmentRequestError;
 ...
 * Decouples the thread state machine from the underlying HTTP authorization and
...
>()("@cadsense/client-runtime/state/threadSnapshotHttp/ThreadSnapshotLoader") {}

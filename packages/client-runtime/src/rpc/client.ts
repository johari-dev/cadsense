import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@cadsense/contracts";
...
}>("@cadsense/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
export type EnvironmentSubscriptionRpcTag =
  ...
  | typeof WS_METHODS.cadCommentsWatch
...
}>("@cadsense/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}

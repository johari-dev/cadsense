...
const URL_GUIDANCE =
  "Absolute http(s) URL or a schemeless host such as cadsense.app or localhost:5173. Schemeless public hosts use https; loopback hosts use http.";
...
export const PreviewAutomationEvaluateInput = Schema.Struct({
  ...
  returnByValue: Schema.optional(
    Schema.Boolean.annotate({
      description:
        "Serialize and return the value instead of an object reference. Defaults to true.",
    }),
  ),
}).annotate({
  description:
...
const PreviewAutomationRendererDiagnosticFields = {
  rendererTag: TrimmedNonEmptyString,
  rendererMessageLength: Schema.Int.check(Schema.isGreaterThanOrEqualTo(0)),
  rendererDetailKind: Schema.optional(
    Schema.Literals(["null", "array", "object", "string", "number", "boolean"]),
  ),
  cause: Schema.Defect(),
};

const PreviewAutomationOptionalRendererDiagnosticFields = {
  rendererTag: Schema.optional(TrimmedNonEmptyString),
  rendererMessageLength: Schema.optional(Schema.Int.check(Schema.isGreaterThanOrEqualTo(0))),
  rendererDetailKind: Schema.optional(
    Schema.Literals(["null", "array", "object", "string", "number", "boolean"]),
  ),
...
export class PreviewAutomationNoAvailableHostError extends Schema.TaggedErrorClass<PreviewAutomationNoAvailableHostError>()(
  "PreviewAutomationNoAvailableHostError",
  {
    ...
    ...PreviewAutomationOptionalRendererDiagnosticFields,
  },
) {
  override get message(): string {
...
export class PreviewAutomationUnsupportedClientError extends Schema.TaggedErrorClass<PreviewAutomationUnsupportedClientError>()(
  "PreviewAutomationUnsupportedClientError",
  {
    ...
    ...PreviewAutomationRendererDiagnosticFields,
  },
) {
  override get message(): string {
...
export class PreviewAutomationRendererUnavailableError extends Schema.TaggedErrorClass<PreviewAutomationRendererUnavailableError>()(
  "PreviewAutomationRendererUnavailableError",
  {
    ...PreviewAutomationRequestErrorFields,
    ...PreviewAutomationRendererDiagnosticFields,
  },

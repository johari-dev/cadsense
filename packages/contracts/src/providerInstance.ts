 ...
 * literal union. Third-party builds can add drivers, and users can move between
 * builds with different driver sets. Either path can leave `ServerSettings`,
 * persisted thread state, or session bindings referencing a driver that the
 * currently-running build does not know about.
 *
 ...
 * third-party driver authors retain reasonable freedom.
 */

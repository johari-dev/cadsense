 ...
 *
 * ```ts
 * import { parseYaml } from "@cadsense/shared/schemaYaml"
 *
 ...
 *
 * ```ts
 * import { stringifyYaml } from "@cadsense/shared/schemaYaml"
 *
 ...
 * ```ts
 * import * as Schema from "effect/Schema"
 * import { fromYamlString } from "@cadsense/shared/schemaYaml"
 *

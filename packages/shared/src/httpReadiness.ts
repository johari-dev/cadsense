...
/**
 * Generic HTTP readiness probe for desktop-managed backend processes. Polls
 * `baseUrl + path` until it returns a 2xx response or the overall
...
>(input: {
  ...
  // while preserving the caller's tagged error.

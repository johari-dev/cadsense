...
This directory maintains the [`cadsense-bin`](https://aur.archlinux.org/packages/cadsense-bin) and
[`cadsense-nightly-bin`](https://aur.archlinux.org/packages/cadsense-nightly-bin) packages. Both

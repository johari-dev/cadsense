...
import { HostProcessEnvironment } from "@cadsense/shared/hostProcess";
...
const ICON_VARIANTS = [
  {
    ...
    outputs: {
      ...
      appIcon: BRAND_ASSET_PATHS.developmentRendererAppIconPng,
  ...
  },
  {
    ...
    outputs: {
      ...
      appIcon: BRAND_ASSET_PATHS.nightlyRendererAppIconPng,
  ...
  },
  {
    ...
    outputs: {
      ...
      appIcon: BRAND_ASSET_PATHS.productionRendererAppIconPng,
...
const renderVariant = Effect.fn("iconExport.renderVariant")(function* (
  ...
  return new Map<string, Buffer>([
    ...
    [variant.outputs.appIcon, yield* render("iOS", 180)],

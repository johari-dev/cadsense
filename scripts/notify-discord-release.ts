  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Cadsense prerelease is available for nightly testers."
          : "A new Cadsense latest release is available.",
...
).pipe(Command.withDescription("Post a Cadsense release announcement to Discord."));

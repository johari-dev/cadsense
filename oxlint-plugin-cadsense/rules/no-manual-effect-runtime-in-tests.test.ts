...
const rule = createOxlintRuleHarness("cadsense/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("cadsense/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("cadsense/no-manual-effect-runtime-in-tests");

...
const rule = createOxlintRuleHarness("cadsense/no-native-title-tooltip", {
  filename: "fixture.tsx",
});

describe("cadsense/no-native-title-tooltip", () => {
  rule.valid(
  ...
  rule.valid("allows document.title assignments", `document.title = "Thread · cadsense";`);
  ...
  rule.invalid(
    ...
    `const el = <code className="truncate" title={resourceUrl}>abc</code>;`,
  );

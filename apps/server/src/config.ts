...
export const RuntimeMode = Schema.Literal("desktop");
...
export interface ServerDerivedPaths {
  ...
  readonly managedWorkspacesDir: string;
...
>()("@cadsense/server/config/ServerConfig") {
...
export const deriveServerPaths = Effect.fn(function* (
  ...
  const managedWorkspacesDir = join(stateDir, "managed-workspaces");
...
export const ensureServerDirectories = Effect.fn(function* (derivedPaths: ServerDerivedPaths) {
  ...
  yield* Effect.all(
    [
      ...
      fs.makeDirectory(derivedPaths.managedWorkspacesDir, { recursive: true }),
...
const makeTest = Effect.fn("ServerConfig.makeTest")(function* (
  ...
  return ServerConfig.of({
    ...
    otlpServiceName: "cadsense-server",
    cwd,
    baseDir,
    ...derivedPaths,
    mode: "desktop",

...
export function buildResourceTelemetryHistory(
  ...
  for (const snapshot of snapshots) {
    ...
    aggregateSamples.push({
      ...
      cpuPercent: merged.groups.allCadsense.currentCpuPercent,
      rssBytes: merged.groups.allCadsense.currentRssBytes,
      processCount: merged.groups.allCadsense.processCount,

...
import { TextGeneration, ThreadTitleGenerationError } from "../../textGeneration/TextGeneration.ts";
...
describe("ProviderCommandReactor", () => {
  ...
  async function createHarness(input?: {
    ...
    const baseDir =
      input?.baseDir ?? NodeFS.mkdtempSync(NodePath.join(NodeOS.tmpdir(), "cadsense-reactor-"));

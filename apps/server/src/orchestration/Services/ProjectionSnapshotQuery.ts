...
export interface ProjectionSnapshotQueryShape {
   ...
   * orchestration engine without hydrating message or activity bodies.
   */
   ...
   * plans are bounded to a page of recent turns and the
...
>()("@cadsense/server/orchestration/Services/ProjectionSnapshotQuery") {}

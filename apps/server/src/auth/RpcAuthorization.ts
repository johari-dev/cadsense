...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.shellOpenInFileManager]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.onshapeConnectionsList]: AuthOrchestrationReadScope,
  [WS_METHODS.onshapeConnectionsCreate]: AuthOrchestrationOperateScope,

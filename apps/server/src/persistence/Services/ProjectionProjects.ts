 ...
 */
import { IsoDateTime, ModelSelection, ProjectId } from "@cadsense/contracts";
...
>()("@cadsense/server/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}

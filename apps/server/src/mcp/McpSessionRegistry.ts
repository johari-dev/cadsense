import { ProviderInstanceId, ThreadId } from "@cadsense/contracts";
...
>()("@cadsense/server/mcp/McpSessionRegistry") {}
 ...
 * the only thing guarding the preview toolkit from an unrelated local process.
 */

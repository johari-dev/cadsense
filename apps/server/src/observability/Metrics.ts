...
export const rpcRequestsTotal = Metric.counter("cadsense_rpc_requests_total", {
  description: "Total RPC requests handled by the websocket RPC server.",
});

export const rpcRequestDuration = Metric.timer("cadsense_rpc_request_duration", {
  description: "RPC request handling duration.",
});

export const orchestrationCommandsTotal = Metric.counter("cadsense_orchestration_commands_total", {
  description: "Total orchestration commands dispatched.",
});

export const orchestrationCommandDuration = Metric.timer(
  "cadsense_orchestration_command_duration",
  {
...
export const orchestrationCommandAckDuration = Metric.timer(
  "cadsense_orchestration_command_ack_duration",
  {
    description:
...
export const orchestrationEventsProcessedTotal = Metric.counter(
  "cadsense_orchestration_events_processed_total",
  {
    description: "Total orchestration intent events processed by runtime reactors.",
  },
);

export const providerSessionsTotal = Metric.counter("cadsense_provider_sessions_total", {
  description: "Total provider session lifecycle operations.",
});

export const providerTurnsTotal = Metric.counter("cadsense_provider_turns_total", {
  description: "Total provider turn lifecycle operations.",
});

export const providerTurnDuration = Metric.timer("cadsense_provider_turn_duration", {
  description: "Provider turn request duration.",
});

export const providerRuntimeEventsTotal = Metric.counter("cadsense_provider_runtime_events_total", {

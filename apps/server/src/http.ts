...
import { isDevProxiedPath } from "@cadsense/shared/devProxy";
...
const DESKTOP_RENDERER_ORIGINS = ["cadsense://app", "cadsense-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    // Only the local Vite renderer and Electron application may call the backend.

...
import { isExplicitRelativePath, isWindowsAbsolutePath } from "@cadsense/shared/path";
import { normalizeSearchQuery } from "@cadsense/shared/searchRanking";
...
>()("@cadsense/server/workspace/WorkspaceEntries") {}

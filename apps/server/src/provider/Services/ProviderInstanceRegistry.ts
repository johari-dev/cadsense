 ...
 *     driver is not registered in this build (cross-version tolerance).
 ...
 */
import type { ProviderInstanceId, ServerProvider } from "@cadsense/contracts";
...
>()("@cadsense/server/provider/Services/ProviderInstanceRegistry") {}

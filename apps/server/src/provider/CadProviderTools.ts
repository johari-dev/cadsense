...
const descriptions = {
  ...
  cad_comments_publish: [
    "Before publishing, check each comment against the CAD review instructions: one useful issue at its marked location, supported by what you inspected, written so the user understands it without the chat. Rewrite or omit comments that fail this check.",

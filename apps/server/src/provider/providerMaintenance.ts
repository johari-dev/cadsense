...
import { compareSemverVersions } from "@cadsense/shared/semver";
import { resolveCommandPath } from "@cadsense/shared/shell";
...
export const ProviderVersionCache = Context.Reference<Map<string, ProviderVersionCacheEntry>>(
  "@cadsense/server/providerMaintenance/ProviderVersionCache",
  {

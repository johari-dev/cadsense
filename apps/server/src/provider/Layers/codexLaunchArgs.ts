import { tokenizeCliArgs } from "@cadsense/shared/cliArgs";

export const CADSENSE_CODEX_LAUNCH_ARGS_ENV = "CADSENSE_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[CADSENSE_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";

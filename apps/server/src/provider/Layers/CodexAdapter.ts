          ...
          ...(mcpSession
            ? {
                environment: {
                  ...
                  CADSENSE_MCP_BEARER_TOKEN: mcpSession.authorizationHeader.replace(
                    /^Bearer\s+/,
                    "",
                  ),
                },
                appServerArgs: [
                  "-c",
                  `mcp_servers.cadsense.url=${mcpSession.endpoint}`,
                  "-c",
                  'mcp_servers.cadsense.bearer_token_env_var="CADSENSE_MCP_BEARER_TOKEN"',
                ],
              }
            : {}),
        };

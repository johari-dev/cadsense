...
} from "@cadsense/shared/claudeCompaction";
...
export const makeClaudeAdapter = Effect.fn("makeClaudeAdapter")(function* (
  ...
  const handleSystemMessage = Effect.fn("handleSystemMessage")(function* (
    ...
    switch (message.subtype) {
      ...
      case "notification":
        ...
        return;
      // Inner protocol/UX details with no cadsense surface today — consumed
      ...
      default: {
        ...
        // The SDK can add informational system messages before its TypeScript
        // union catches up. They are not application activity.
        return;
      }
    }
  });
  ...
  const handleSdkMessage = Effect.fn("handleSdkMessage")(function* (
    ...
    // Wire-only command bookkeeping has no user-facing cadsense lifecycle.
    ...
    switch (message.type) {
      ...
      case "rate_limit_event":
        ...
        return;
      // Composer prompt suggestions have no cadsense surface; consumed deliberately.
  ...
  const stopSessionInternal = Effect.fn("stopSessionInternal")(function* (
    ...
    // must not stay open, or the thread can never finish.
  ...
  const startSession: ClaudeAdapterShape["startSession"] = Effect.fn("startSession")(
    function* (input) {
      ...
      const handleAskUserQuestion = Effect.fn("handleAskUserQuestion")(function* (
        ...
        // expected lookup key. See https://github.com/johari-dev/cadsense/issues/2388

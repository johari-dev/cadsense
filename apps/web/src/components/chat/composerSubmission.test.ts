import { PROVIDER_SEND_TURN_MAX_INPUT_CHARS } from "@cadsense/contracts";
...
describe("submitComposerDraft", () => {
  ...
  it("blocks when appended context pushes the provider input over the shared limit", () => {
    ...
    expect(result).toEqual({
      validationMessage:
        "Prompt is 15 characters over the 120,000-character limit. Shorten or split it before sending.",
      didDispatch: false,
    });

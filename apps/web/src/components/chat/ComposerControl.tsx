...
const composerControlClassName =
  "h-6 min-h-6 gap-1 rounded-[var(--control-radius)] px-2 text-xs text-secondary-label transition-none hover:text-foreground sm:h-6 sm:min-h-6 sm:text-xs [&_svg[data-composer-control-icon]]:mx-0 [&_svg[data-composer-control-chevron]]:-mx-0.5";
...
export function ComposerControlChevron() {
  return (
    <ChevronDownIcon
      aria-hidden="true"
      className="-mx-0.5 size-3 shrink-0 text-icon-muted"

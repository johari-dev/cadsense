...
export function ProviderInstanceCard({
  ...
  const { copyToClipboard } = useCopyToClipboard<{ providerName: string }>({
    onCopy: ({ providerName }) => {
      toastManager.add({
        ...
        description: "Run it in your shell when you are ready to update.",
      });
    },
  ...
  // headline shows so the user can act without opening the details panel.
    ...
    return (
      <div
        className={cn(
          ...
          // Foreground-alpha tint keeps the fill legible on the fixed dark surface.

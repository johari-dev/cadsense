import type { DiscoveredLocalServer } from "@cadsense/contracts";
import { isLoopbackHost } from "@cadsense/shared/preview";
...
export interface PreviewableServer extends DiscoveredLocalServer {
  ...
  /**
   * Pre-resolution loopback URL. History keys off this stable value rather
   * than the resolved navigation target.
   */
  requestedUrl: string;
}

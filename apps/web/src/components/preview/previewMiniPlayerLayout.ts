import type { PreviewViewportSetting } from "@cadsense/contracts";
...
// CAD previews do not mirror a browser viewport, so they keep independent dimensions.
...
/** Constrains independently sized previews, such as the floating CAD viewer. */

        ...
        <Sheet onOpenChange={setOpenMobile} open={openMobile} {...props}>
          ...
          >
            <SheetHeader className="sr-only">
              ...
              <SheetDescription>Displays the compact sidebar.</SheetDescription>
            </SheetHeader>
            <div
              className={cn(
  ...
  return (
    <SidebarInstanceContext value={instanceContextValue}>
      ...
      >
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) md:flex transition-[left,right,width] duration-150 ease-out motion-reduce:transition-none",
            side === "left"
...
function SidebarGroupAction({ className, render, ...props }: useRender.ComponentProps<"button">) {
  const defaultProps = {
    className: cn(
      ...
      // Increases the hit area of the button on compact layouts.

...
import type { DesktopPreviewFavicon, ScopedProjectRef, ScopedThreadRef } from "@cadsense/contracts";
...
const BROWSER_FAVICON_STORAGE_KEY = "cadsense:browser-favicons:v1";

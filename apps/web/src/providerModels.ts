...
import { createModelCapabilities, resolveSelectableModel } from "@cadsense/shared/model";
...
// Plan mode is not exposed by the app. Drop provider-reported plan options so
// stale selections cannot leak into dispatch.

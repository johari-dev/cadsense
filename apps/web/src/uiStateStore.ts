...
const LEGACY_PERSISTED_STATE_KEYS = [
  "cadsense:renderer-state:v8",
  "cadsense:renderer-state:v7",
  "cadsense:renderer-state:v6",
  "cadsense:renderer-state:v5",
  "cadsense:renderer-state:v4",
  "cadsense:renderer-state:v3",

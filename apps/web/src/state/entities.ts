...
/** Whether the environment supports thread pinning. */
...
/** Whether the environment supports thread title regeneration. */
...
/** Whether the environment supports ordering pinned threads. */

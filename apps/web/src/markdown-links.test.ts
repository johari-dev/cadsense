...
describe("rewriteMarkdownFileUriHref", () => {
  ...
  it("normalizes file uri hrefs for windows drive paths", () => {
    expect(
      rewriteMarkdownFileUriHref(
        "file:///D:/Programme/cadsense/apps/web/src/components/chat/FileTagChip.tsx#L69",
      ),
    ).toBe("D:/Programme/cadsense/apps/web/src/components/chat/FileTagChip.tsx#L69");
  });
...
describe("resolveMarkdownFileLinkTarget", () => {
  ...
  it("normalizes slash-prefixed windows drive paths before resolving", () => {
    expect(
      resolveMarkdownFileLinkTarget(
        "/D:/Programme/cadsense/apps/web/src/components/chat/FileTagChip.tsx#L69",
      ),
    ).toBe("D:/Programme/cadsense/apps/web/src/components/chat/FileTagChip.tsx:69");
  });
...
describe("resolveInlineCodeFileLinkMeta", () => {
  ...
  it("ignores commands, flags, and expressions", () => {
    expect(resolveInlineCodeFileLinkMeta("node --version")).toBeNull();
  ...
  it("ignores extension-less relative segments and directories", () => {
    expect(resolveInlineCodeFileLinkMeta("folder/item", "/Users/julius/project")).toBeNull();

...
describe("composerSubmissionIntentForEnter", () => {
  ...
  it("inserts a newline for plain Enter in compact layouts", () => {
    expect(
      composerSubmissionIntentForEnter({
...
describe("detectComposerTrigger", () => {
  ...
  it("detects a slash trigger in the middle of a message", () => {
  ...
  it("does not use dollar signs as skill triggers", () => {
    const text = "Use $gh-fi";

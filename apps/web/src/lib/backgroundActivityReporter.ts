import { EnvironmentRegistry } from "@cadsense/client-runtime/connection";
import {
  EnvironmentRpcSubscriptionObserver,
  request,
  type EnvironmentRpcSubscriptionObservation,
} from "@cadsense/client-runtime/rpc";
import {
...
const CLIENT_ID_STORAGE_KEY = "cadsense.backgroundActivity.clientId";

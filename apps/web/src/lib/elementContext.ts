...
import type { PickedElementPayload, PickedElementStackFrame } from "@cadsense/contracts";
 ...
 * append to the user's outgoing message text. Mirrors the other structured context

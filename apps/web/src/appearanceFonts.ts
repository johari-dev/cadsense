...
export const TYPOGRAPHY_ADVANCED_STORAGE_KEY = "cadsense:typography-advanced";
...
/**
 * Whether a family renders every character on the same advance.
 *
...
function resolveGenericFamilyLabel(generic: string): string | null {
  ...
  // No nameable face matched; on macOS that means one of the San

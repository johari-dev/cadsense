...
const PIERRE_ICON_SPRITE_ID = "cadsense-pierre-file-icon-sprite";

const CADSENSE_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="cadsense-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="cadsense-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="cadsense-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="cadsense-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="cadsense-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="cadsense-file-icon-pnpm" viewBox="0 0 32 32">
...
export const CADSENSE_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: CADSENSE_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "cadsense-file-icon-package-json",
    "tsconfig.json": "cadsense-file-icon-tsconfig",
    "agents.md": "cadsense-file-icon-agents",
    "claude.md": "cadsense-file-icon-claude",
    "readme.md": "cadsense-file-icon-readme",
    "pnpm-lock.yaml": "cadsense-file-icon-pnpm",
    "pnpm-workspace.yaml": "cadsense-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(CADSENSE_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${CADSENSE_FILE_ICON_SPRITE}`;

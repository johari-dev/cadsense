...
import { waitForHttpReady as waitForHttpReadyShared } from "@cadsense/shared/httpReadiness";
...
const BACKEND_READINESS_PATH = "/.well-known/cadsense/environment";
...
export interface DesktopBackendStartConfig extends BackendProcessContext {
  ...
  // CADSENSE_HOME can't pin the WSL backend to /mnt/c/...\.cadsense.

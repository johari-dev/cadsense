...
function getGnomeKeyringRemediationMessage(): string {
  return "cadsense could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart cadsense.";
}

function getKWalletRemediationMessage(): string {
  return "cadsense could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart cadsense.";
}

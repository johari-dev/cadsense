...
// oxlint-disable-next-line cadsense/no-global-process-runtime -- Electron exposes the client platform in its sandboxed preload process.
...
contextBridge.exposeInMainWorld("desktopBridge", {
  ...
  openInFileManager: (input) => ipcRenderer.invoke(IpcChannels.OPEN_IN_FILE_MANAGER_CHANNEL, input),

...
>()("@cadsense/desktop/app/DesktopEnvironment") {}
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = resolveDesktopBaseDir({
    homeDirectory,
    joinPath: path.join,
    cadsenseHome: config.cadsenseHome,
  });
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.cadsense.cadsense.dev" : "com.cadsense.cadsense",
    ),
    linuxDesktopEntryName: isDevelopment ? "cadsense-dev.desktop" : "cadsense.desktop",
    linuxWmClass: isDevelopment ? "cadsense-dev" : "cadsense",
    userDataDirName,

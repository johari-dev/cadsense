...
export class DesktopDevelopmentBackendPortRequiredError extends Schema.TaggedErrorClass<DesktopDevelopmentBackendPortRequiredError>()(
  ...
  override get message(): string {
    return "CADSENSE_PORT is required in desktop development.";
  }
}
...
const bootstrap = Effect.gen(function* () {
  ...
  yield* configuration.setPrimaryPort(backendPort);
  const httpBaseUrl = new URL(`http://127.0.0.1:${backendPort}`);
